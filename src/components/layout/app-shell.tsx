...
const exemploNotificacoes = [
  {
    ...
    title: (
      <span>
        <strong>João</strong> comentou: "O ajuste ficou ótimo!"
      </span>
    ),
    description: '',
    timestamp: '2 min',
  ...
  },
  {
    ...
    title: (
      <span>
        <strong>Tarefa concluída:</strong> Limpeza finalizada
      </span>
    ),
    description: '',
    timestamp: '15 min',
  ...
  },
  {
    ...
    title: (
      <span>
        <strong>Novo Pagamento:</strong> R$ 350,00 recebido
      </span>
    ),
    description: '',
    timestamp: '45 min',
...
export function AppShell({
  ...
  // ========================================
  // FECHAR PERFIL AO MUDAR DE ROTA
  // ========================================
  useEffect(() => {
            ...
            >
              {notificacoes.length > 0 ? (
                ...
                <div className="px-4 py-8 text-center">
                  <Icon
                    name="notifications"
                    className="mx-auto text-4xl text-slate-300 mb-2"
                  />
        ...
        <div className="w-full mx-4 bg-white rounded-lg shadow-xl">
          <div className="flex items-center gap-2 p-4 border-b border-slate-200">
            ...
            <div className="flex-1 relative">
              <Icon
                name="search"
                className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-400 text-lg"
              />
              ...
              <input
                ...
                value={busca}
                onChange={(e) =>
                  handleBuscaModal(e.target.value)
                }
                className="w-full pl-10 pr-4 py-2 bg-slate-100 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition"
              />
            </div>
